...
Object::Object(float distance1, float speed1,  signed int direction1, signed int direction21, unsigned int pause1, float double21,  float scale1)
{  
  level = 0;
  /*
    # Blender File for a Cube
...
void Object::Update(unsigned int dt)
{
 ...
 // std::cout << "\n";
  ...
  angle2 +=  dt * M_PI/1000* direction2 * pause * speed * double2;
